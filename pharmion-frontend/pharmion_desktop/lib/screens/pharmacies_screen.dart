              ...
              child: DropdownButtonFormField<bool?>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                      value: false,
                      child:
                          Text('Inactive', style: TextStyle(fontSize: 13))),
                ],
                onChanged: (val) {
                  setState(() {
                    _isActive = val;
          ...
          Expanded(
            ...
            child: Row(children: [
              const Icon(Icons.location_on_outlined,
                  size: 13, color: AppColors.kTextMid),
...
class _PharmacyDialogState extends State<_PharmacyDialog> {
  ...
  InputDecoration _inputDeco({String? hint, String? label}) =>
      InputDecoration(
        labelText: label,
        labelStyle:
          ...
          child: Column(
              ...
              children: [
                ...
                TextField(
                    ...
                    decoration:
                        _inputDeco(hint: 'e.g. LUPRIV PHARM 1')),
                ...
                TextField(
                    ...
                    style: const TextStyle(
                        fontSize: 13, color: AppColors.kTextDark),
                    decoration:
                        _inputDeco(hint: 'e.g. Ferhadija 1')),
                const SizedBox(height: 14),
