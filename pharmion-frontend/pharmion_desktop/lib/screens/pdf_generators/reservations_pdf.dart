...
class ReservationsPdfGenerator {
  static Future<Uint8List> generate({
    ...
    final totalPatientPays = reservations.fold<double>(
      0,
      (s, r) => s + r.patientPaysAmount,
    );
    final totalInsurance = reservations.fold<double>(
      0,
      (s, r) => s + r.insurancePaysAmount,
    );
        ...
        children: [
            ...
            children: [
              ...
              pw.Column(
                ...
                children: [
                  pw.Text(
                    'PHARMION',
                    style: _style(size: 15, color: PdfColors.white, bold: true),
                  ),
                  pw.Text(
                    'Reservations Report',
                    style: _style(
          ...
          pw.Column(
            ...
            children: [
              ...
              pw.Text(
                pharmacyName,
                style: _style(size: 9, color: PdfColors.white, bold: true),
              ),
    ...
    pw.Widget _finCard(String value, String label, PdfColor fg, PdfColor bg) =>
        pw.Expanded(
          child: pw.Container(
            ...
            child: pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                pw.Text(value, style: _style(size: 14, color: fg, bold: true)),
      ...
      children: [
        pw.Row(
          children: [
            ...
            pw.SizedBox(width: 8),
            _finCard(
              '${totalInsurance.toStringAsFixed(2)} KM',
              'Insurance Pays',
              orange,
              orangeLight,
            ),
              ...
              children: [
                ...
                ...statusCounts.entries.map(
                  (e) => pw.Container(
                    ...
                    child: pw.Text(
                      '${e.key}: ${e.value}',
                      style: _style(size: 7, color: textDark, bold: true),
                    ),
                  ),
                ),
              ],
      ...
      child: pw.Row(
        children: [
          pw.SizedBox(
            ...
            child: pw.Text(
              '#',
              style: _style(size: 7, color: PdfColors.white, bold: true),
            ),
          ),
          pw.Expanded(
            flex: 3,
          ...
          children: [
            ...
            pw.Expanded(
              ...
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text(r.patientName, style: _style(size: 8, bold: true)),
                  pw.Text(
                    r.patientEmail,
    ...
    pw.Widget _totalsRow() => pw.Container(
      ...
      child: pw.Row(
        children: [
          ...
          pw.Expanded(
            flex: 3,
            child: pw.Text('TOTAL', style: _style(size: 8, bold: true)),
          ),
