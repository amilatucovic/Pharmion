        ...
        children: [
            ...
            children: [
              ...
              pw.Column(
                ...
                children: [
                  pw.Text(
                    'PHARMION',
                    style: ts(size: 14, color: PdfColors.white, bold: true),
                  ),
                  pw.Text(
          ...
          pw.Column(
            ...
            children: [
              ...
              pw.Text(
                pharmacyName,
                style: ts(size: 9, color: PdfColors.white, bold: true),
              ),
        ...
        children: [
          if (showPharmacyColumn) ...[
            pw.Expanded(
              ...
              child: pw.Text(
                'Product',
                style: ts(size: 7, color: PdfColors.white, bold: true),
              ),
            ),
            pw.Expanded(
              flex: 2,
            ...
            pw.SizedBox(
              ...
              child: pw.Text(
                ...
                style: ts(
                  size: 8,
                  bold: true,
                  color: item.isLowStock ? red : green,
                ),
              ),
            ),
            pw.SizedBox(
      ...
      pw.MultiPage(
        ...
        footer: (ctx) => pw.Container(
          ...
          child: pw.Row(
            ...
            children: [
              pw.Text(
                'Pharmion — Inventory Status Report',
                style: ts(size: 7, color: textMid),
              ),
              pw.Text(
