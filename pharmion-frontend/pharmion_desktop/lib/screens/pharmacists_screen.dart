                  ...
                  Container(
                    ...
                    child: Row(
                      children: const [
                        ...
                        Expanded(
                          flex: 2,
                          child: Text('License Number', style: _headerStyle),
                        ),
                        Expanded(
                          flex: 1,
                          child: Text(
                  ...
                  Expanded(
                    child: _loading
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) => _PharmacistRow(
                              pharmacist: _pharmacists[index],
                              isEven: index.isEven,
                              onEdit: () => _openEdit(_pharmacists[index]),
                              onToggleActive: () =>
              ...
              children: [
                Row(
                  children: [
                    ...
                    const SizedBox(width: 12),
                    Text(
                      _isEdit ? 'Edit Pharmacist' : 'New Pharmacist',
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: AppColors.kTextDark,
                    ...
                    Expanded(
                      child: _Field(
                        ...
                        child: TextField(
                          ...
                          decoration: _deco(hint: 'e.g. Amira'),
                        ),
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: _Field(
                        ...
                        child: TextField(
                          ...
                          decoration: _deco(hint: 'e.g. Hodžić'),
                        ),
                      ),
                    ),
                  ],
                      ...
                      Expanded(
                        child: _Field(
                          ...
                          child: TextField(
                            ...
                            decoration: _deco(hint: 'e.g. amira.hodzic'),
                          ),
                        ),
                      ),
                      const SizedBox(width: 12),
                    ...
                    Expanded(
                      child: _Field(
                        ...
                        child: TextField(
                          ...
                          decoration: _deco(hint: 'e.g. amira@lupriv.ba'),
                        ),
                      ),
                    ),
                  ],
                      ...
                      Expanded(
                        child: _Field(
                          ...
                          child: TextField(
                            ...
                            decoration: _deco(hint: 'Min. 8 characters')
                                .copyWith(
                      ...
                      Expanded(
                        child: _Field(
                          ...
                          child: TextField(
                            ...
                            decoration: _deco(hint: 'Repeat password').copyWith(
                              suffixIcon: IconButton(
                                icon: Icon(
                                  _showConfirm
                                      ? Icons.visibility_off_outlined
                    ...
                    Expanded(
                      child: _Field(
                        ...
                        child: TextField(
                          ...
                          decoration: _deco(hint: 'e.g. MAG-2022-0001'),
                        ),
                      ),
                    ),
                    const SizedBox(width: 12),
                      ...
                      child: _Field(
                        ...
                        child: DropdownButtonFormField<int?>(
                          ...
                          items: widget.pharmacies
                              ...
                              .toList(),
                          onChanged: (v) =>
                              setState(() => _selectedPharmacyId = v),
                        ),
                      ),
                    ),
                  ],
                  ...
                  children: [
                    Expanded(
                      child: _ToggleRow(
                        ...
                        onChanged: (v) => setState(() => _isAdministrator = v),
                      ),
                    ),
                    if (_isEdit) ...[
                      const SizedBox(width: 12),
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      label: Text(
                        _isEdit ? 'Save Changes' : 'Create Pharmacist',
                        style: const TextStyle(fontSize: 13),
                      ),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: AppColors.kTeal,
    ...
    child: AnimatedContainer(
      ...
      child: Text(
        ...
        style: TextStyle(
          fontSize: 13,
          fontWeight: FontWeight.w500,
          color: selected ? AppColors.kTeal : AppColors.kTextMid,
        ),
      ),
    ),
  );
